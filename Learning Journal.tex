...
\underline{Formatting data tables in Spreadsheets}
\linebreak
...
\vspace{5mm}
\underline{Find examples of problem in data produced by your discipline}\\
...
\begin{subsection}{Data Carpentry (Spreadsheets)}
