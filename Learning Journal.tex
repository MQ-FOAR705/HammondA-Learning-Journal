...
\action{1/11/2019 13:41}
\intention{Create corpus with a file hosted in dropbox}
\action{Uploaded a pdf to drop box and linked it in the server config}
\result{Error failed to create corpus}
...
\actionlog{08/11/2019 01:59}
\intention{Upload project to Github}
\action{Dragged and dropped project folder into the upload section for my Github repository}
\result{Some files were too big}
\solution{Upload repository to Cloudstor and have multiple options in the readme}
