...
\question{Transform three more columns, no_members, yrs_liv, and buildings_in_compound, from text to numbers. Can all columns be transformed to numbers? - Try it with village for example.}
Not possible to change Village into number values, only one was changed which was likely the mistake of village '49'
\begin{itemize}
...
\begin{itemize}
    \item All the changes made in OpenRefine are logged and stored 
\end{itemize}
